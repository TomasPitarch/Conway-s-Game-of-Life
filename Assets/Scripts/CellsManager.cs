...
public class CellsManager : MonoBehaviour
{
    ...
    [Header("Settings")]
    [SerializeField] private SimulationType _currentType;
    public SimulationType currentType
    {
        ...
        set
        {
            ...
            {
                _currentType = value;
                OnSimulationTypeChanged?.Invoke(_currentType);
            }
        }
    }
    public event Action<SimulationType> OnSimulationTypeChanged;

    [SerializeField] private ComputeShader gpuComputeShader;
    ...
    void Awake()
    {
        ...
        simulationStrategies.Add(SimulationType.GPU, new GPUSimulation(gpuComputeShader));
    ...
    private void OnDestroy()
    {
        ...
        if (simulationStrategies != null)
        {
            foreach (var strategy in simulationStrategies.Values)
            {
                strategy.Cleanup();
            }
        }
...
public enum SimulationType { Classic, Burst, GPU }